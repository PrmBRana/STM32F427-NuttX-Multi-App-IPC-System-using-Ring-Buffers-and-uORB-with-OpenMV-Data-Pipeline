/****************************************************************************
 * boards/arm/stm32/stm32f427-custom/include/board.h
 *
...
#ifndef __BOARDS_ARM_STM32_STM32F427_CUSTOM_INCLUDE_BOARD_H
#define __BOARDS_ARM_STM32_STM32F427_CUSTOM_INCLUDE_BOARD_H
...
/* The STM32F427-CUSTOM board features a single 8MHz crystal.
...
/* The STM32F427-CUSTOM supports one button: */
...
/* PWM
 *
 * The STM32F427-CUSTOM has no real on-board PWM devices, but the board can
...
#define GPIO_SPI3_NSS  (GPIO_SPI3_NSS_3|GPIO_SPEED_50MHz)
...
# ifdef CONFIG_STM32F427_CUSTOM_ILI9341_FBIFACE

/* LCD
 *
 * The STM32F427-CUSTOM board contains an onboard TFT LCD connected to the
...
#if defined(CONFIG_STM32F427_CUSTOM_ILI9341_FBIFACE_LANDSCAPE) || \
    defined(CONFIG_STM32F427_CUSTOM_ILI9341_FBIFACE_RLANDSCAPE)
...
#endif /* __BOARDS_ARM_STM32_STM32F427_CUSTOM_INCLUDE_BOARD_H */
