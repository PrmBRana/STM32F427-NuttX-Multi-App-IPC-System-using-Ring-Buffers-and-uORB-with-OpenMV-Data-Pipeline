/****************************************************************************
 * boards/arm/stm32/stm32f427-custom/src/stm32_spi.c
 *
 ...
 *
 * Description:
 *   Called to configure SPI chip select GPIO pins for the stm32f427-custom
 *   board.
 *
 ****************************************************************************/
...
#if defined(CONFIG_STM32F427_CUSTOM_ILI9341)
