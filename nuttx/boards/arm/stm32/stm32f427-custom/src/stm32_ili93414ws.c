/****************************************************************************
 * boards/arm/stm32/stm32f427-custom/src/stm32_ili93414ws.c
 *
...
#ifndef CONFIG_STM32F427_CUSTOM_ILI9341_SPIFREQUENCY
#  define CONFIG_STM32F427_CUSTOM_ILI9341_SPIFREQUENCY      20000000
#endif

#if CONFIG_STM32F427_CUSTOM_ILI9341_SPIFREQUENCY >= \
                                        (STM32_PCLK1_FREQUENCY >> 1)
#  define ILI93414WS_SPI_BR         SPI_CR1_FPCLCKd2    /* 000: fPCLK/2 */
#  define ILI93414WS_BAUD_DIVISOR   2
#elif CONFIG_STM32F427_CUSTOM_ILI9341_SPIFREQUENCY >= \
...
#ifndef CONFIG_STM32F427_CUSTOM_ILI9341_SPIBITS16
...
#ifdef CONFIG_STM32F427_CUSTOM_ILI9341_SPIBITS16
