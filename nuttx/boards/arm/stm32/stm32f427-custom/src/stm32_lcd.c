/****************************************************************************
 * boards/arm/stm32/stm32f427-custom/src/stm32_lcd.c
 *
...
#ifdef CONFIG_STM32F427_CUSTOM_ILI9341_LCDDEVICE
#  define ILI9341_LCD_DEVICE CONFIG_STM32F427_CUSTOM_ILI9341_LCDDEVICE
#else
...
#elif defined(CONFIG_STM32F427_CUSTOM_ILI9341_FBIFACE_PORTRAIT)
#  define STM32_ILI9341_MADCTL_PARAM  ILI9341_MADCTL_PORTRAIT_PARAM1
#elif defined(CONFIG_STM32F427_CUSTOM_ILI9341_FBIFACE_RLANDSCAPE)
#  define STM32_ILI9341_MADCTL_PARAM  ILI9341_MADCTL_RLANDSCAPE_PARAM1
# warning "ILI9341 doesn't support full landscape with RGB interface"
#elif defined(CONFIG_STM32F427_CUSTOM_ILI9341_FBIFACE_RPORTRAIT)
...
#endif /* CONFIG_STM32F427_CUSTOM_ILI9341_FBIFACE */

/****************************************************************************
 * Private Data
 ****************************************************************************/

#ifdef CONFIG_STM32F427_CUSTOM_ILI9341_LCDIFACE
...
#endif /* CONFIG_STM32F427_CUSTOM_ILI9341_LCDIFACE */
