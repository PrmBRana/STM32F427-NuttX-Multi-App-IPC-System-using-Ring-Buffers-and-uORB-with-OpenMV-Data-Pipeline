/****************************************************************************
 * boards/arm/stm32/stm32f427-custom/src/stm32_bringup.c
 *
...
#ifndef CONFIG_STM32F427_CUSTOM_FLASH_MINOR
#define CONFIG_STM32F427_CUSTOM_FLASH_MINOR 0
#endif

#ifdef CONFIG_STM32F427_CUSTOM_FLASH_CONFIG_PART
...
int stm32_bringup(void)
{
  ...
  struct spi_dev_s *spi4 = NULL;
#endif
#if defined(CONFIG_STM32_SPI3)
  struct spi_dev_s *spi3 = NULL;
#endif
  ...
  const char *partname = CONFIG_STM32F427_CUSTOM_FLASH_PART_NAMES;
#endif
  int ret;
...
#ifdef CONFIG_STM32F427_CUSTOM_FLASH_PART
        {
          int partno;
          int partsize;
          int partoffset;
          int partszbytes;
          int erasesize;
          const char *partstring = CONFIG_STM32F427_CUSTOM_FLASH_PART_LIST;
          const char *ptr;
          ...
          while (*ptr != '\0')
            {
              ...
              if (CONFIG_STM32F427_CUSTOM_FLASH_CONFIG_PART_NUMBER == partno)
                {
...
#endif
                {
                  ...
                  smart_initialize(CONFIG_STM32F427_CUSTOM_FLASH_MINOR,
                                   mtd_part, partref);
#endif
                }
...
#else /* CONFIG_STM32F427_CUSTOM_FLASH_PART */

      /* Configure the device with no partition support */

      smart_initialize(CONFIG_STM32F427_CUSTOM_FLASH_MINOR, mtd, NULL);

#endif /* CONFIG_STM32F427_CUSTOM_FLASH_PART */
    }
...
#if defined(CONFIG_RAMMTD) && defined(CONFIG_STM32F427_CUSTOM_RAMMTD)
  /* Create a RAM MTD device if configured */

    {
      uint8_t *start =
          kmm_malloc(CONFIG_STM32F427_CUSTOM_RAMMTD_SIZE * 1024);
      mtd = rammtd_initialize(start,
                              CONFIG_STM32F427_CUSTOM_RAMMTD_SIZE * 1024);
...
#if defined(CONFIG_MTD_SMART) && defined(CONFIG_FS_SMARTFS)
      smart_initialize(CONFIG_STM32F427_CUSTOM_RAMMTD_MINOR, mtd, NULL);
#endif
    }

#endif /* CONFIG_RAMMTD && CONFIG_STM32F427_CUSTOM_RAMMTD */
