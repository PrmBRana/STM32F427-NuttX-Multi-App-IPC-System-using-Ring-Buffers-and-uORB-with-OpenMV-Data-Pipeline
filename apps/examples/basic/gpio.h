...
#define GPIO_MY_PA2 (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_50MHZ | GPIO_OUTPUT_CLEAR | GPIO_PORTA | GPIO_PIN2)
#define GPIO_MY_PA3 (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_50MHZ | GPIO_OUTPUT_CLEAR | GPIO_PORTA | GPIO_PIN3)
/****************************************************************************
 * Public DataFCUBE
 ****************************************************************************/
